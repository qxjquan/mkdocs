...
latex_documents = [
    (master_doc, 'mkdics.tex', 'mkdocs Documentation',
     'quanxj', 'manual'),
]
...
man_pages = [
    (master_doc, 'mkdocs', 'mkdocs Documentation',
     [author], 1)
]
...
texinfo_documents = [
    (master_doc, 'mkdocs', 'mkdocs Documentation',
     author, 'mkdocs', 'One line description of project.',
     'Miscellaneous'),
]
